  ...
  Future<void> _showMyDialog() async {
    ...
    return showDialog<void>(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          title: const Text('¿Olvidaste tu NIP?'),
          content: SingleChildScrollView(
            child: ListBody(
              children: <Widget>[
                Text('Para recuperar tu NIP da click en el siguente enlace'),
                SizedBox(
                  height: 10,
                ),
                Column(
                  children: [
                    InkWell(
                      onTap: () {
                        launchUrl(Uri.parse(
                            //'https://api.whatsapp.com/send?phone=52${splashController.configModel.companyPhone}'
