                ...
                Container(
                  child: Column(children: [
                    ...
                    if(Get.find<SplashController>().configModel.twoFactor) GetBuilder<ProfileController>(builder: (profileController){
                      return profileController.isLoading ? TwoFactorShimmer() : StatusMenu(
                        title: 'two_factor_authentication'.tr, leading: Image.asset(Images.two_factor_authentication,width: 28.0),
                      );
                    }),
                    ...
                    CustomInkWell(
                      child: widget.MenuItem(iconData: Icons.delete, image: null, title: 'delete_account'.tr),
                      onTap: () {
